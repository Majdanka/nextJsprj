...
export default function Dashboard() {
  return (
    <>
      <fieldset className="mt-2 w-[98%] border border-gray-700 rounded-3xl bg-slate-300 h-[50vh] flex-col flex items-center">
      ...
      <fieldset className="mt-2 w-[98%] border border-gray-700 rounded-3xl bg-slate-300 h-[44vh] flex-col flex items-center">
        <legend className="ml-2 text-gray-700 font-bold text-[1.2rem]">
          Users
        </legend>
