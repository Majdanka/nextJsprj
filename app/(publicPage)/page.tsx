...
export default function Home() {
  return (
    <>
      <main className="w-full md:w-[69%] bg-orange-300 rounded-3xl md:h-[80vh] flex flex-col items-center h-[100vh]">
      ...
      <aside className="md:m-0 w-full md:w-[30%] rounded-3xl h-[58vh] md:h-[80vh] bg-violet-300 flex flex-col items-center">
